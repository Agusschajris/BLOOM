...
-- AlterTable
ALTER TABLE "Class" ALTER COLUMN "ownerId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Dataset" ALTER COLUMN "userId" SET DATA TYPE TEXT;
...
-- AlterTable
ALTER TABLE "_UserClasses" ALTER COLUMN "B" SET DATA TYPE TEXT;
